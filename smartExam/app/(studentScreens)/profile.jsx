...
import {View,Text,StyleSheet,TouchableOpacity,TextInput,Alert,KeyboardAvoidingView,Platform,ScrollView,RefreshControl,} from "react-native";
...
export default function Profile() {
  ...
  const handleSave = async () => {
    try {
      const response = await fetch("http://smartexam.somee.com/api/UpdateStudentProfile", {
        method: "PUT",
        headers: {
      ...
      >
        <Animated.View style={styles.profileCard} entering={FadeInUp.duration(500)}>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.infoBlock}>
              <Text style={styles.label}>Exams Done</Text>
              <Text style={styles.infoText}>{user.examsDone}</Text>
            </View>
          </View>
